...
embedding_dim = 8  # You can change this to any embedding dimension you prefer
...
gcn = GCN(in_channels=graph.x.size(1), hidden_channels=8, out_channels=8, vector_emb_dim=query_encoder.bert.config.hidden_size, graph_type=args.graph_type)
